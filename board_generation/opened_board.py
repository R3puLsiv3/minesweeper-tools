...
class OpenedBoard(Board):
    """
    An opened board is a board which has a start cell that is guaranteed to not be a mine. This prevents the player
    from hitting a mine on their first click which is typically considered as undesirable game behavior.
    ...
    def __place_mines(self, amount_mines: int) -> None:
        ...
        mines on the board at those positions while avoiding the start cell.
        """
