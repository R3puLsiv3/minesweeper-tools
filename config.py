...
OPTIONS_HEIGHT: Final[int] = 6 * OPTIONS_PADDING + 5 * OPTION_HEIGHT
...
TEXT_ENTRY_AMOUNT_MINES_X = OPTIONS_X + OPTIONS_PADDING

TEXT_ENTRY_AMOUNT_MINES_Y = TEXT_ENTRY_HEIGHT_Y + OPTIONS_PADDING + OPTION_HEIGHT

BUTTON_CREATE_X = OPTIONS_X + OPTIONS_PADDING

BUTTON_CREATE_Y = TEXT_ENTRY_AMOUNT_MINES_Y + OPTIONS_PADDING + OPTION_HEIGHT

TEXT_MINE_COUNTER_X = OPTIONS_X + OPTIONS_PADDING

TEXT_MINE_COUNTER_Y = BUTTON_CREATE_Y + OPTIONS_PADDING + OPTION_HEIGHT
